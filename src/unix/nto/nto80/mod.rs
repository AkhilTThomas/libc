...
s! {
    ...
    pub struct _thread_attr {
        ...
        pub __policy: c_int,
        pub __param: super::__sched_param,
...
pub const IHFLOW: super::tcflag_t = 0x00000001;
pub const IIDLE: super::tcflag_t = 0x00000008;
pub const IPTOS_ECN_NOTECT: u8 = 0x00;
pub const IUCLC: super::tcflag_t = 0x00000200;
pub const IUTF8: super::tcflag_t = 0x0004000;
...
pub const PTHREAD_COND_INITIALIZER: super::pthread_cond_t = super::pthread_cond_t {
    __u: super::CLOCK_REALTIME as u32,
    __owner: 0xfffffffb,
};
...
pub const PTHREAD_RWLOCK_INITIALIZER: super::pthread_rwlock_t = super::pthread_rwlock_t {
    __count: 0,
    __owner: 0,
};
...
// Network related functions are provided by libsocket
#[link(name = "socket")]
extern "C" {
    ...
    pub fn getpwent_r(
        pwd: *mut super::passwd,
        buf: *mut c_char,
        __bufsize: size_t,
        __result: *mut *mut super::passwd,
    ) -> c_int;
    ...
    pub fn MsgInfo(__rcvid: rcvid_t, __info: *mut super::_msg_info64) -> c_int;
    pub fn MsgInfo_r(__rcvid: rcvid_t, __info: *mut super::_msg_info64) -> c_int;
    ...
    pub fn MsgSendPulse(__coid: c_int, __priority: c_int, __code: c_int, __value: c_long) -> c_int;
    ...
    pub fn MsgDeliverEvent(__rcvid: rcvid_t, __event: *const super::sigevent) -> c_int;
    pub fn MsgDeliverEvent_r(__rcvid: rcvid_t, __event: *const super::sigevent) -> c_int;
    pub fn MsgVerifyEvent(__rcvid: rcvid_t, __event: *const super::sigevent) -> c_int;
    pub fn MsgVerifyEvent_r(__rcvid: rcvid_t, __event: *const super::sigevent) -> c_int;
    pub fn ChannelCtl(__chid: c_int, __cmd: c_int, data: *mut c_void) -> c_int;
    pub fn ChannelCtl_r(__chid: c_int, __cmd: c_int, data: *mut c_void) -> c_int;
    pub fn TimerTimeout(
        __id: super::clockid_t,
        __flags: u32,
        __notify: *const super::sigevent,
        __ntime: *const u64,
        __otime: *mut u64,
    ) -> c_int;
    ...
    pub fn TimerDelegate(__action: u32, owner_cpu: u32, delegate_cpu: u32) -> c_int;
    pub fn TimerDelegate_r(__action: u32, owner_cpu: u32, delegate_cpu: u32) -> c_int;
